...
| 4.2d membership entries skipped, tracked claims untouched | skipped e2e — same constraint; hazard pinned in `sync.test.ts` › skips membership claims (byte-identical) + unit rows |
