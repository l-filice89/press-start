...
| **Time-to-beat shelf filter** | A shelf filter group over the 10.3 hours: five bands (≤25h, 25–50h, 50–75h, 75–100h, >100h) + `Unknown`, story/100% toggle, FR-20 semantics. Pure client-side over already-persisted fields. **Owned by Epic 12, story 12.1 (VR-9)** — after Epic 10 (shipped v2.1.0). | new (2026-07-16), `epics.md` (Story 12.1), `sprint-change-proposal-2026-07-16-ttb-filter.md` |
