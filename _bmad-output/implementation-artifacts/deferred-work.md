...
- source_spec: `_bmad-output/implementation-artifacts/spec-3-2-flag-pills-and-state-reveal-pills.md`
  ...
  decision: 2026-07-10 Assigned to the pre-4.2 hardening bundle (epic 3 retro action item 2) — must land before Story 4.2 introduces sync as a new write source; invalidate ['shelf-search'] alongside ['shelf'] in every onSuccess.
...
- source_spec: `_bmad-output/implementation-artifacts/spec-3-4-focus-interaction-hardening-deferred-work-sweep.md`
  ...
  decision: 2026-07-10 Assigned to the pre-4.2 hardening bundle — Epic 4 sync makes refetch-while-interacting a real path (a sync completing while a menu is open kills it); hoist menu open-state like the 3.4 panel fix AND remove the openStatusMenu retry loop in the same change.
- source_spec: `_bmad-output/implementation-artifacts/spec-3-4-focus-interaction-hardening-deferred-work-sweep.md`
...
- source_spec: `_bmad-output/implementation-artifacts/spec-3-4-focus-interaction-hardening-deferred-work-sweep.md`
  ...
  decision: 2026-07-10 Assigned to the pre-4.2 hardening bundle (epic 3 retro action item 3) — latest-write token (or dismiss stale undo toasts on newer writes) required before sync introduces automated writes that a stale UNDO could clobber.
